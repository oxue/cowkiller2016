...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			type.set ("assets/images/darklord.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/farmer.png", "assets/images/farmer.png");
			type.set ("assets/images/farmer.png", Reflect.field (AssetType, "image".toUpperCase ()));
