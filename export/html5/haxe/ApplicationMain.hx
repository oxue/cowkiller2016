...
class ApplicationMain {
	...
	private static function preload() {
		...
		loadFile("assets/images/cow.png");
		loadFile("assets/images/darklord.png");
		loadFile("assets/images/farmer.png");
		loadFile("assets/images/fireball.png");
		loadFile("assets/images/g.png");
