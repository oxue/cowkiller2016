...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/cow.png", __ASSET__assets_images_cow_png);
		type.set ("assets/images/cow.png", AssetType.IMAGE);
		className.set ("assets/images/darklord.png", __ASSET__assets_images_darklord_png);
		type.set ("assets/images/darklord.png", AssetType.IMAGE);
		className.set ("assets/images/farmer.png", __ASSET__assets_images_farmer_png);
		type.set ("assets/images/farmer.png", AssetType.IMAGE);
		...
		className.set ("assets/images/g.png", __ASSET__assets_images_g_png);
...
@:keep class __ASSET__assets_images_cow_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__assets_images_darklord_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__assets_images_farmer_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__assets_images_fireball_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__assets_images_g_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:bitmap("assets/images/cow.png") class __ASSET__assets_images_cow_png extends flash.display.BitmapData {}
@:bitmap("assets/images/darklord.png") class __ASSET__assets_images_darklord_png extends flash.display.BitmapData {}
@:bitmap("assets/images/farmer.png") class __ASSET__assets_images_farmer_png extends flash.display.BitmapData {}
@:bitmap("assets/images/fireball.png") class __ASSET__assets_images_fireball_png extends flash.display.BitmapData {}
@:bitmap("assets/images/g.png") class __ASSET__assets_images_g_png extends flash.display.BitmapData {}
...
@:sound("C:/HaxeToolkit/haxe/lib/flixel/3,3,4/assets/sounds/beep.ogg") class __ASSET__assets_sounds_beep_ogg extends flash.media.Sound {}
@:sound("C:/HaxeToolkit/haxe/lib/flixel/3,3,4/assets/sounds/flixel.ogg") class __ASSET__assets_sounds_flixel_ogg extends flash.media.Sound {}
